...
public class MemberServlet extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action ==null || action.equals("listMembers")) {
			...
			pw.print("<script>" + " alert('가입을 완료했습니다.');" + " location.href='"+request.getContextPath()+"/mem4.do';" +" </script>");
			return;
			...
			nextPage="/mem4.do?action=listMembers";
			PrintWriter pw = response.getWriter();
			pw.print("<script>" + " alert('수정을 완료했습니다.');" + " location.href='"+request.getContextPath()+"/mem4.do';" +" </script>");
			return;
			...
			nextPage="/mem4.do?action=listMembers";
			PrintWriter pw = response.getWriter();
			pw.print("<script>" + " alert('삭제를 완료했습니다.');" + " location.href='"+request.getContextPath()+"/mem4.do';" +" </script>");
			return;
			...
			memList.add(new MemberVO("s2","1234","foreachInsert","m1@test.com"));
			memList.add(new MemberVO("s3","1234","foreachInsert","m1@test.com"));
