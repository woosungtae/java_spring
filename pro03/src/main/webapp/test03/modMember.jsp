	...
	<form method="post" action="${contextPath}/mem4.do?action=updateMember&id=${memInfo.id}">
		...
		<table align="center">
			...
			<tr>
				...
				<td width="400"><input type="password" value="${memInfo.pwd}" name="pwd"></td>
			</tr>
			<tr>
				<td width="200"><p align="right">이름</td>
				<td width="400"><input type="text" value="${memInfo.name}" name="name"></td>
			</tr>
			<tr>
				<td width="200"><p align="right">이메일</td>
				<td width="400"><input type="email" value="${memInfo.email}" name="email"></td>
			</tr>
			<tr>
				<td width="200"><p>&nbsp;</p></td>
